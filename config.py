...
# （原 HYDE_INJURY_KEYWORDS 已删，2026-09-11：零引用。它是 hyde 早期的
#  「关键词计数」实现留下的，后来 classify_query 改成实体词典贪心抽取
#  （见 hyde.py:45），这份列表再没有任何读取方。）
...
# （原 SSE_CHUNK_CHARS 已删，2026-09-11：真流式改造后只被 api.py 死导入、无任何读取方）
